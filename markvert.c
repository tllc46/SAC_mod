...
extern color COLORS[]; //250326 Donglin Choi: Set time picks color
     ...
     int nmarks;
{
    ...
    setcolor(COLORS[1]); //250326 Donglin Choi
	...
	line(*xloc-0.005,yloc1,*xloc+0.005,yloc1);//250326 Donglin Choi
	line(*xloc-0.005,yloc2,*xloc+0.005,yloc2);

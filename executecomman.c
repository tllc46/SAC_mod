...
void /*FUNCTION*/
executecommand(module, index, nerr, kinmsg) //220306 Donglin Choi: LOAD EXTERNAL_COMMAND
     int module, index, *nerr;
     char *kinmsg; //220306 Donglin Choi: LOAD EXTERNAL_COMMAND
{
    ...
    *nerr = 0;
    ...
    if (module == MODULEEXTCOM) {       /* - "External Command Module" */
        zexecute(index, nerr, kinmsg); //220306 Donglin Choi: LOAD EXTERNAL_COMMAND
        goto L_8888;
    }
